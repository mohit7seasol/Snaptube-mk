...
class IntroVC1: UIViewController {
    ...
    func setLoca() {
        self.titleLabel.text = "Save All Media Files".localized(LocalizationService.shared.language)
        self.subTitleLabel.text = "Easily save images, videos, & more to your device.".localized(LocalizationService.shared.language)
    ...
    @IBAction func nextButtonAction(_ sender: UIButton) {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "IntroVC2") as! IntroVC2
