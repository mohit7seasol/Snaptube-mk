...
class IntroVC2: UIViewController {
    ...
    func setLoca() {
        self.titleLabel.text = "Edit Photo & Video".localized(LocalizationService.shared.language)
        self.subTitleLabel.text = "Easily edit your photos & videos in one place.".localized(LocalizationService.shared.language)
    ...
    @IBAction func nextButtonAction(_ sender: UIButton) {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "IntroVC3") as! IntroVC3
