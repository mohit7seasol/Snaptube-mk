...
extension UIView {
    ...
    /// 添加内边距
    func paddingToSuperView(left: CGFloat? = nil,
                                    top: CGFloat? = nil,
                                    right: CGFloat? = nil,
                                    bottom: CGFloat? = nil,
                                    width: CGFloat? = nil,
...
open class VCAsserts: NSObject {
    ...
    open class var closeImage: UIImage { return VCAsserts.bundledImage(named: "textInput_close") }
    open class var resizeImage: UIImage { return VCAsserts.bundledImage(named: "textInput_increase") }
    open class var rotateImage: UIImage { return VCAsserts.bundledImage(named: "textInput_rotation") } // ADD ROTATION IMAGE
